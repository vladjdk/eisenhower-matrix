...
export type Task={id:string;title:string;notes:string;q:number;x:number;y:number;done:boolean;due:string;sources:Link[];links:Link[];created_at?:string;aged_from?:string};
